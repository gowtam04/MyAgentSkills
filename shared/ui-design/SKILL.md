...
name: ui-design
description: >
  Create distinctive, production-grade frontend interfaces with committed art
  direction, a token-driven design system, full interaction and failure states,
  and accessibility by default. Use this skill whenever the user asks to build,
  design, restyle, polish, or beautify any web UI — landing pages, marketing
  sites, dashboards, app screens, components, HTML/CSS layouts, React/Vue/Svelte
  UIs, design systems, or visual redesigns — or when they want the result to
  look premium, intentional, non-generic, brand-led, or not AI-generated. Prefer
  this skill over ad-hoc styling whenever visual quality, brand personality,
  typography, motion, layout originality, or production completeness
  (hover/focus/loading/error/empty/offline states) matters, even if they only
  say "make it look good" or "clean UI."
---
