...
- **Asset review:** View the images (Read tool) and the contact sheet. Engine-ready defaults (size, transparency, palette adherence, silhouette at game scale, frame alignment, style-lock match). Do not request a new art direction.
